        ...
        <div className="md:hidden">
            ...
            {open && (
                <div className="py-4 space-y-4">
                    ...
                    <Link href="/#about" onClick={() => setOpen(false)} className="block text-sm font-medium hover:text-primary">За нас</Link>
                    <Link href="/#board" onClick={() => setOpen(false)} className="block text-sm font-medium hover:text-primary"> Управителен съвет</Link>
                    <Link href="/#membership" onClick={() => setOpen(false)} className="block text-sm font-medium hover:text-primary">Членство</Link>
                    <Link href="/#blog" onClick={() => setOpen(false)} className="block text-sm font-medium hover:text-primary">Позиции и публикации</Link>
